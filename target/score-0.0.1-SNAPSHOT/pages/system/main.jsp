	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="height: 25px;" align="right">
				<td style="" colspan="2">
				<div style="background: url(src/main/webapp/image/common/top_bg.jpg) no-repeat right center; float: right;">
				...
				<div id="layout_north_zxMenu" style="width: 100px; display: none;">
					...
					<div onclick="exit('loginController.do?logout','确定退出该系统吗 ?');">tuichuxitong</div>
				</div>	
				</div>
				</div>
				</td>
